...
void ExtractFrustumPlanes(XMFLOAT4 planes[6], CXMMATRIX M)
{
	...
	// Bottom
	//
	planes[2].x = M.r[0].m128_f32[3] + M.r[0].m128_f32[0];
	planes[2].y = M.r[1].m128_f32[3] + M.r[1].m128_f32[0];
	planes[2].z = M.r[2].m128_f32[3] + M.r[2].m128_f32[0];
	planes[2].w = M.r[3].m128_f32[3] + M.r[3].m128_f32[0];

	//
	// Top
	//
	planes[3].x = M.r[0].m128_f32[3] + M.r[0].m128_f32[0];
	planes[3].y = M.r[1].m128_f32[3] + M.r[1].m128_f32[0];
	planes[3].z = M.r[2].m128_f32[3] + M.r[2].m128_f32[0];
	planes[3].w = M.r[3].m128_f32[3] + M.r[3].m128_f32[0];
