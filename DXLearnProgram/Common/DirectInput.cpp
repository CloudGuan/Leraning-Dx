//=============================================================================
// DirectInput.cpp by Frank D. Luna (C) 2005 All Rights Reserved.
//=============================================================================

#include "d3dUtil.h"
#include "DirectInput.h"
#include "d3dApp.h" // In order to access the 
...
DirectInput::DirectInput(DWORD keyboardCoopFlags, DWORD mouseCoopFlags)
{
	...
	HR(DirectInput8Create(gd3dApp->AppInst(), DIRECTINPUT_VERSION,
	...
	HR(mKeyboard->SetCooperativeLevel(gd3dApp->MainWnd(), keyboardCoopFlags));
	HR(mKeyboard->Acquire());

	HR(mDInput->CreateDevice(GUID_SysMouse, &mMouse, 0));
	HR(mMouse->SetDataFormat(&c_dfDIMouse2));
	HR(mMouse->SetCooperativeLevel(gd3dApp->MainWnd(), mouseCoopFlags));
	HR(mMouse->Acquire());
}
